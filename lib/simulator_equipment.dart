...
class SimulatorEquipment extends StatefulWidget {
  final props;

  SimulatorEquipment(this.props);

  @override
  _SimulatorEquipmentState createState() => _SimulatorEquipmentState();
}

class _SimulatorEquipmentState extends State<SimulatorEquipment> with TickerProviderStateMixin {
