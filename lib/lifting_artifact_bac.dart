...
//      print('new ${animationLoadingController.status}');
  ...
  OverlayEntry createSelectPopupWindow(width, height, top) {
    OverlayEntry overlayEntry = new OverlayEntry(builder: (context) {
      return new Positioned(
        width: width,
        height: height - (top + 56 + ScreenUtil.getInstance().setWidth(120)),
        top: top + 56 + ScreenUtil.getInstance().setWidth(120),
